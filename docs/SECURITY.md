...
Preencha o seguinte formulário para reportar uma vulnerabilidade: [Issue Request](https://github.com/clcmo/MiExt/issues/new?assignees=&labels=&template=bug_report.md&title=), com as seguintes informações: 
...
1. **Confirmação do relatório**: Verificamos a validade do relatório de vulnerabilidade.
